...
//FMA version
static inline v4sf log_ps_fma(v4sf x) {
  v4sf one = vdupq_n_f32(1);
...
//FMA version
static inline v4sf exp_ps_fma(v4sf x) {
  v4sf tmp, fx;
...
//FMA version
static inline void sincos_ps_fma(v4sf x, v4sf *ysin, v4sf *ycos) { // any x
  v4sf xmm1, xmm2, xmm3, y;
...
//FMA version
static inline v4sf sin_ps_fma(v4sf x) {
  v4sf ysin, ycos; 
  sincos_ps_fma(x, &ysin, &ycos); 
  return ysin;
}

//FMA version
static inline v4sf cos_ps_fma(v4sf x) {
  v4sf ysin, ycos; 
  sincos_ps_fma(x, &ysin, &ycos); 
  return ycos;
}
